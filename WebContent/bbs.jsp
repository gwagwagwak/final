	...
	<div align=center>
		<div class="container">
			<table class="table">
				<thead>
					<tr
						style="text-align: left; height: 60px; background-color: #fec503; font-size: 18px; border-color: #1a1a1a; border: 1px">
						<th
							style="text-align: left; height: 60px; background-color: #5D5D5D; font-size: 18px; width: 10%; color: white;">번호</th>
			...
			<a href="write.jsp?id=<%=id%>" class="btn btn-warning pull-right">글작성</a>
			<br> <br>
